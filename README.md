...
## Учебный проект 
# 🐱 **Бот заботы о питомцах — Чат-бот для пет-сервиса "Ваш любимчик"**
...
- ✅ Привлечь внимание целевой аудитории (владельцы домашних животных)
...
- 🎁 Пользователь может скачать **PDF-файл с полезными рекомендациями** для владельцев домашних животных  
